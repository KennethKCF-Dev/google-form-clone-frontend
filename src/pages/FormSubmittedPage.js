...
import { fetchFormByID, selectCurrentForm } from "../redux/slice/formsSlice";
import {
  HeadingCard,
  FormTitle,
  FormDescription,
} from "../components/headingDisplayCard/StyledComponent";
  ...
  return (
    <Container>
      <HeadingCard>
        ...
        <OtherResponseButton to={`/form/${formId}`}>
