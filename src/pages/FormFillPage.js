...
import { Container, RecButton } from '../components/common/CommonStyledComponent';
...
const FormFiller = () => {
    ...
    return (
        <Container>
            <HeadingDisplayCard title={currentForm.title} description={currentForm.description} />
            {currentForm.questions.map((question, index) => (
                <QuestionDisplayCard key={index} question={question} answers={answers[question._id]} onChange={(e) => handleInputChange(question._id, e.target.value)} />
            ))}
            <Footer>
